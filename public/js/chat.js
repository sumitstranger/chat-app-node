...
const Roomsidebartemplate = document.querySelector('#Roomsidebar-template').innerHTML
...
socket.on('roomListvalue',({roomlist})=>{
    ...
    document.querySelector('#Roomsidebar').innerHTML = html
